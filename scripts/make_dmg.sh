...
cd "$(dirname "$0")/.."
APP_PATH="dist/Gelato.app"
DMG_PATH="dist/Gelato.dmg"
...
hdiutil create -volname "Gelato" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "Gelato"
    ...
    set position of item "Gelato.app" of container window to {120, 150}
